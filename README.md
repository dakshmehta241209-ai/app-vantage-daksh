...
Sign in as Faculty and create an assignment.
Record attendance for a class.
Sign in as Student and verify that attendance has updated.
Submit the assignment and register for an event.
Sign in as Coordinator and inspect the event registration.
Sign in as Admin and review platform statistics and user controls.
Demo credentials
...
See ER_DIAGRAM.md for the complete ER diagram.
...
npm, pnpm or yarn
Installation
git clone (https://github.com/dakshmehta24…
